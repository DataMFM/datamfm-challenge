...
class call_BLEU():
    ...
    def evaluate(self, group_info=[], save_name='default'):
        ...
        for group_name, samples in group_samples.items():
            ...
            bleu = hf_evaluate.load("bleu", keep_in_memory=True, experiment_id=random.randint(1,1e8))
    ...
    def evaluate(self, group_info=[], save_name='default'):
        ...
        for group_name, samples in group_samples.items():
            ...
            for sample in samples:
                ...
                predictions.append(gt)
                references.append(pred)
            meteor = hf_evaluate.load('meteor', keep_in_memory=True, experiment_id=random.randint(1,1e8))
